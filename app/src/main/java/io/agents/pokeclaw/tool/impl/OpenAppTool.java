...
public class OpenAppTool extends BaseTool {
    ...
    private String resolveAppName(String appName) {
        ...
        switch (lower) {
            ...
            case "whatsapp business": return "com.whatsapp.w4b";
            case "wa business": return "com.whatsapp.w4b";
            case "whatsapp bisnis": return "com.whatsapp.w4b";
            case "wa bisnis": return "com.whatsapp.w4b";

...
enum class CloudProvider(
    ...
    DEEPSEEK(
        ...
        models = listOf(
            CloudModel("deepseek-chat", "DeepSeek Chat (v4)", 0.14, 0.28, ModelTier.SMART, 64_000),
            CloudModel("deepseek-v4-flash", "DeepSeek v4 Flash", 0.05, 0.10, ModelTier.FAST, 64_000, recommended = true),
